...
class HashTable:
    ...
    def _hash(self, key): # leading underscore means "private" so don't use it outside of the class-- but you CAN use it outside of the class!
        '''
